...
public class VideoFragmentZongYi extends Fragment implements MyHttpCallBack, View.OnClickListener {
    ...
    private final int httpBannerType = 2299;

    private final int httpClassType = 2312;
...
//        new OkHttpUtils(httpBannerType, this).SetApiUrl(banner)
//                .SetKey("type")
//                .SetValue("5")
//                .isCache()
//                .POST();
...
//                    .putExtra(KEY.TITLE, getString(com.judian.watch.videos.R.string.fxyj))
