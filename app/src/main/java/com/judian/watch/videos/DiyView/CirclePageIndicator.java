...
public class CirclePageIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultFillColor = res.getColor(R.color.black);
        final int defaultOrientation = 0;
        final int defaultStrokeColor = res.getColor(R.color.white);
        final float defaultStrokeWidth = res.getDimension(R.dimen.dp_0);
        ...
        mOrientation = a.getInt(R.styleable.CirclePageIndicator_my_orientation, defaultOrientation);
        ...
        mRadius = a.getDimension(R.styleable.waveSideBar_radius, defaultRadius);
        mSnap = a.getBoolean(R.styleable.CirclePageIndicator_snap, defaultSnap);

        Drawable background = a.getDrawable(R.styleable.CirclePageIndicator_my_background);
        if (background != null) {
