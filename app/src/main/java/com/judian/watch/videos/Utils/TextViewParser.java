...
public class TextViewParser {
     ...
     * @return
     */
    public TextViewParser append(String text, int size, int color) {
        if (text == null) {
            return this;
        }
    ...
    public void parse(TextView textView) {
        ...
        // 所有的文字和效果都要写在Spannable中，SpannableStringBuilder用于创建Spannable，
        ...
        for (TextBean bean : textList) {
            ...
            /*
             * 如上所示，Spannable接口是说这个类可以被改变，Span说的是这个类可以去改变别的类
