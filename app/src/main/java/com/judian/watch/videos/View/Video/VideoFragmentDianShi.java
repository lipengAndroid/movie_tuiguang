...
public class VideoFragmentDianShi extends Fragment implements MyHttpCallBack, View.OnClickListener {
    ...
    private final int httpBannerType = 221;

    private final int httpClassType = 231;
...
//            VipDialog.show(mContext, new DialogListener() {
//                @Override
