...
import com.judian.watch.videos.Utils.DpiUtil;
...
public class ViewPagerIndicator extends LinearLayout {
     ...
     * 标题正常时的颜色
     */
    private int OnClick = Color.parseColor("#66ffffff");

    /**
     * 标题选中时的颜色
     */
    private int Click = Color.parseColor("#ffffff");
    ...
    protected void highLightTextView(int position) {
        ...
        if (view instanceof TextView) {
            ((TextView) view).setTextColor(Click);
        }
    ...
    private void resetTextViewColor() {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (view instanceof TextView) {
                ((TextView) view).setTextColor(OnClick);
            }
        }
    }
    ...
    private TextView generateTextView(String text) {
        ...
        tv.setBackgroundResource(R.drawable.bg_click_gray);
        tv.setTextColor(OnClick);
        tv.setText(text);
    ...
    public int getScreenWidth() {
        ...
        return outMetrics.widthPixels - DpiUtil.dip2px(getContext());
    }
