...
import static com.judian.watch.videos.Utils.StringUtils.stringFormatting;
import static com.judian.watch.videos.Utils.StringUtils.unicodeToString;
...
public class OkHttpUtils {
    ...
    public OkHttpUtils(int httpType, MyHttpCallBack callBack) {
    ...
    public OkHttpUtils SetFile(File file) {
        this.file = file;
        return this;
    }

    public OkHttpUtils isCache() {
        this.Cache = true;
        return this;
    }
                ...
                switch (RequestType) {
                    ...
                    case POST_TWO:
                        ...
                        try {
                            ...
                            LogUtils.e(unicodeToString(stringFormatting(StringJson)));
